  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-6 sm:gap-8 md:gap-10 z-10 h-full w-full px-4">
        <div className="w-full sm:w-[80%] md:w-[60%] lg:w-[35%]">
          <VideoItem></VideoItem>
        </div>
        <div className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center w-full sm:w-4/5 md:w-2/3 lg:w-1/2">
          Dasma realizohët vetëm njëherë, po me ZOOM Production...
        </div>

        <div className="flex flex-col items-center w-full sm:w-4/5 md:w-2/3 lg:w-1/2">
